...
-- ----------------------------
BEGIN;
INSERT INTO `oa_user` VALUES (1, 'oasuper', 'c13f62012fd6a8fdf06b3452a94430e5', 'rpR6Bv', '超级管理员', '', 0, '系统管理员', '', '', '', 'admin@163.com', '', '', '2019-01-01', '', 1, 1, 1, '2019-01-01', '2019-01-01 00:00:00', '127.0.0.1', 0, '2019-01-01 00:00:00', '2019-01-01 00:00:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `oa_department` VALUES (1, 0, '{$companyname}', 999999, '{$datetime}', '{$datetime}');
COMMIT;

-- ----------------------------
-- Records of oa_department_staff
-- ----------------------------
BEGIN;
INSERT INTO `oa_department_staff` VALUES (1, 1, 1, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `oa_area` (`id`, `pid`, `shortname`, `name`, `mergename`, `level`, `pinyin`, `code`, `zip`, `first`, `lng`, `lat`) VALUES
...
-- ----------------------------
-- Records of oa_geek_conf
-- ----------------------------
BEGIN;
INSERT INTO `oa_department_staff` VALUES (1, 1, '2019-09-02', 9, 40);
COMMIT;