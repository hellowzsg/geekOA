...
class Api extends Command
{
    ...
    protected function configure()
    {
        ...
        $this
            ...
            ->addOption('title', 't', Option::VALUE_OPTIONAL, 'document title', $app_name)
            ->addOption('author', 'a', Option::VALUE_OPTIONAL, 'document author', $app_name)
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        // 目标目录
        $output_dir = \Env::get('root_path') . 'public' . DIRECTORY_SEPARATOR;
        ...
        $moduleDir = \Env::get('app_path') . $module . DIRECTORY_SEPARATOR;
        if (!is_dir($moduleDir)) {
